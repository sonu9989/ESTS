...
Developed By: - R.B. Cleveland

Citation: - Cleveland, R.B., Cleveland, W.S., McRae, J.E., Terpenning, I., 1990. STL: A Seasonal-Trend Decomposition Procedure Based on Loess. J. Off. Stat. 6, 3–73.
...
#Accessing Decomposition Component (Eg. Seasonal, Trend & Residue)
...
decomp_csv.to_csv("Station_decomposed_s.csv", header=["Original","Trend", "Seasonal","Residual"], index_label= "Time")